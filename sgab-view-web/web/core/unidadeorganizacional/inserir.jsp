...
<%@include file="/core/header.jsp" %>
    ...
    <center>
        ...
        <section id="form">
            <div id="caixa-form">
                <form name="inserirAtendente" method="post">
                    ...
                    <div class="caixa-form-footer">
                        <input type="button" class="button" name="ordem" value="Cadastrar" onclick="gravarAlteracao(document.inserirAtendente)">
                        <a href="/sgab/main?acao=PessoaListar">Listar Atendentes</a><br>
                    </div>
                </form>
            </div>
        </section>
