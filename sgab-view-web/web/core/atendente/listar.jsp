            ...
            <form name="listarAtendente" method="post">
                ...
                <table id="pessoa">
                    ...
                    %>
                        <tr>
                            <td>
                                <a href="/sgab/main?acao=PessoaAlterar&pessoaId=<%=atendente.getId()%>"><%=atendente.getId()%></a>
                            </td>
                            <td>
                                <a href="/sgab/main?acao=PessoaAlterar&pessoaId=<%=atendente.getId()%>"><%=atendente.getLogin()%></a>
                            </td>
                            <td>
                                <a href="/sgab/main?acao=PessoaAlterar&pessoaId=<%=atendente.getId()%>"><%=atendente.getCpf()%></a>
                            </td>
                            <td>
                                <a href="/sgab/main?acao=PessoaAlterar&pessoaId=<%=atendente.getId()%>"><%=atendente.getNome()%></a>
                            </td>
                            <td>
                                <a href="/sgab/main?acao=PessoaAlterar&pessoaId=<%=atendente.getId()%>"><%=atendente.getEmail()%></a>
                            </td>
                            <td>
